...
Vagrant.configure("2") do |config|
  ...
  config.vm.define "Testing" do |vmHost1|
    ...
    config.vm.define :"Producción" do |vmHost2|
      vmHost2.vm.box = "generic/fedora38"
      ...
      # Agrego los nuevo disco 

      vmHost2.vm.disk :disk, size: "5GB", name: "#{vmHost2.vm.hostname}_extra_storage"
      vmHost2.vm.disk :disk, size: "3GB", name: "#{vmHost2.vm.hostname}_extra_storage2"
      vmHost2.vm.disk :disk, size: "2GB", name: "#{vmHost2.vm.hostname}_extra_storage3"
      vmHost2.vm.disk :disk, size: "1GB", name: "#{vmHost2.vm.hostname}_extra_storage4"
